...
class WindowsDerivedIdentityContracts(unittest.TestCase):
    ...
    def test_windows_usn_transform_matches_rust_fixtures(self) -> None:
        self.assertEqual(corpusdb._rust_windows_usn_token(0), 0x55534E5F46494C45)
        self.assertEqual(
