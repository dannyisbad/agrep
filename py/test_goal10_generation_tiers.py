"""Goal 10 D2/D6 routine tiers: bounded alias clones, deferred deep proofs.
...
from test_goal8_search_freshness import _family_meta, _publish  # noqa: E402
...
class AliasCloneBound(unittest.TestCase):
    ...
    def test_unbounded_default_keeps_the_foreign_reader_path(self) -> None:
        # Goal-9 R8 owned-by proofs read through this exact fallback; the
