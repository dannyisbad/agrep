"""Display policy below the Claude-owned render seam."""
...
class LineageDedupTests(unittest.TestCase):
    ...
    def test_lived_prose_and_failures_never_near_fold(self) -> None:
        text = "The disk filled because stale build scratch consumed 20GB. " * 2
    ...
    def test_exact_cross_family_fold_belongs_to_the_caller(self) -> None:
        text = (
            "Identical fixture output can occur in unrelated runs; the "
